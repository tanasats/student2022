const actorganizationModel = require("../model/actorganization.model");
...
exports.filter = async(req,res) => {
  try{
    ...
    const [[_results], [[_count]]] = await Promise.all([
      actorganizationModel.filter({page:page,pagesize:pagesize,keyword:keyword}),
      actorganizationModel.countfilter({keyword:keyword})
    ]);
...
exports.create = async (req, res) => {
  ...
  datas.mdate = new Date();
  if (req.body.actorganization_name) {
